        ...
        for gold in gold_file:
            if doc_key == gold['doc_key']:
                ...
                for i in gold['clusters']:
                    ...
                    # print(' '.join(sentences[i[1][0]:i[1][1] + 1]))
                    # print("\n", 'predicted:')
                    gold_s = i[0][0]
                    gold_e = i[0][1]
                    gold_s_pro = i[1][0]
                ...
                for i in pred:
                    ...
                    # print(sentences[i[1][0]:i[1][1]])
                    if i[0][0] == gold_s and i[0][1] == gold_e and i[1][0] == gold_s_pro and i[1][1] == gold_e_pro:
                        num += 1
                        print(sentences[i[0][0]:i[0][1]])
                print("__________________")
    print("num:", num)


if __name__ == '__main__':
    gold_path = '/home/patsnap/PycharmProjects/webanno_preprocess/data/jsonline_data/xulei1/count_xulei1.jsonlines'
    predicted_path = '/home/patsnap/PycharmProjects/webanno_preprocess/data/jsonline_data/xulei1/coref_predictions.json'
